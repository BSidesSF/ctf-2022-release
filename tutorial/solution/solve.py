...
import pwnlib.shellcraft.i386.linux as linux_sc
import pwnlib.shellcraft.i386 as x86_sc
...
def main():
    pwnlib.context.context.update(os='linux', arch='i386')
    if len(sys.argv) == 2:
